...
const devwebLibrary = [

  {
    ...
    description: "Site web pour accueillir tout type d’événements et activités dans un endroit convivial en Savoie. Intégration web basée à partir d’une maquette fournie dans l’agence Nouvel Oeil.",
  ...
  },
  {
    ...
    number: "02",
    title: "Saintiki",
    description: "Site web vitrine présentant une villa à louer près de Saint-Tropez. Intégration web basée à partir d’une maquette fournie dans l’agence Nouvel Oeil.",
  ...
  },
  {
    ...
    number: "03",
    title: "Prolactine",
    description: "Site web d’un affineur fromager. Création d’une maquette et intégration web d’un site vitrine dans l’agence Nouvel Oeil.",
